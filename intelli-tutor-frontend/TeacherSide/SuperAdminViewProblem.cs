...
{
    internal class SuperAdminViewProblem
    {
        MainProblemsModel problem = new MainProblemsModel();
        MainProblemApi problemApi = new MainProblemApi();
        public async void ShowSuperAdminViewProblem(MainContentModel content, FlowLayoutPanel flowLayoutPanel, Label formName, MainWeekModel weekData)
        {
            ...
            if (problem != null)
            {
                ...
                backButton.Click += async (sender, e) =>
                {
                    ...
                    superAdminCourseContent.ShowSuperAdminCourseContent(weekData, flowLayoutPanel, formName);

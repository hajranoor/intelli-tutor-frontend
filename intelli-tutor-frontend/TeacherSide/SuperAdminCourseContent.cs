...
namespace intelli_tutor_frontend.TeacherSide
{
    internal class SuperAdminCourseContent
    {
        ...
        public async void SuperAdminCourseContentShow(MainWeekModel weekData , FlowLayoutPanel flowLayoutPanel, Label formName)
        {
            mainContentModels = await mainContentApi.getMainContentByWeekId(weekData.week_id);
        ...
        public async void SuperAdminMyCoursesContentShow(WeekModel weekData, FlowLayoutPanel flowLayoutPanel, Label formName)
        {

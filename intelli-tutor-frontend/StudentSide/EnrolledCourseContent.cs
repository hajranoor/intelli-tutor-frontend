...
{
    internal class EnrolledCourseContent
    {
        List<ContentModel> contentList = new List<ContentModel>();
        ContentApi contentApi = new ContentApi();
        public async void EnrolledCourseContentShow(int week_id , FlowLayoutPanel flowLayoutPanel1)
        {
            contentList = await contentApi.getContentByWeekId(week_id);
